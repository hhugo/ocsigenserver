...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8d94f88a490a3bf72b0ad7d927fa425d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          files_ab = ["src/baselib/ocsigen_config.ml.ab"];
          sections =
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Compile with natdynlink support";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Polytables"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "ocsigenserver";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ocsigen_getcommandline"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "ocsigenserver";
                      lib_findlib_name = None;
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("netstring-pcre", None);
                           FindlibPackage ("findlib", None);
                           InternalLibrary "commandline";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/http-cookie";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("lwt", None);
                           InternalLibrary "baselib"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                 ...
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "baselib";
                           InternalLibrary "http";
                           InternalLibrary "polytables";
                           InternalLibrary "ocsigenserver";
                           FindlibPackage ("lwt.unix", None);
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Redirectmod"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = ["ocsigenserver"; "ext"];
                      });
               Library
                 ({
                     cs_name = "outputfilter";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Extendconfiguration"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\162\030\006X\188\1366\235\238\195\n;h\165d\220";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
